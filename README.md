...
3. Run **`INSTALL TEST CERTIFICATE FIRST.cmd`** as Administrator and approve if UAC prompted.
4. Run **`3 ENABLE TESTSIGNING.cmd`** as Administrator and approve if UAC prompted.
5. **Reboot Windows.**
6. Run **`4 INSTALL DRIVER.cmd`** as Administrator and approve if UAC prompted.
...
1. Run **`5 UNINSTALL DRIVER.cmd`** as Administrator and approve if UAC prompted.
2. Reboot Windows.
3. If you no longer need Windows TESTSIGNING mode for anything else, run **`6 DISABLE TESTSIGNING.cmd`** as Administrator and approve if UAC prompted.
